...
export const ruInformationQuery =
  "SELECT id,type, title_ru as title, description_ru as description, url, created_at as createdAt FROM information WHERE type=? LIMIT ? OFFSET ? ";
export const uzInformationQuery =
  "SELECT id,type, title_uz as title, description_uz as description, url, created_at as createdAt FROM information WHERE type=?  LIMIT ? OFFSET ? ";
export const fullInformationQuery =
  "SELECT id,type, title, title_ru as titleRu, title_uz as titleUz, description, description_ru as descriptionRu, description_uz as descriptionUz, url, created_at as createdAt FROM information WHERE type=?  LIMIT ? OFFSET ? ";
export const enInformationQuery =
  "SELECT id,type, title, description, url, created_at as createdAt FROM information WHERE type=?  LIMIT ? OFFSET ? ";
