...
export const getAllById = "SELECT type, name, name_ru, name_uz, position, position_ru, position_uz, work_hours, work_hours_ru, work_hours_uz,phone, email,tg, biography, work_history, duty,is_boss,url FROM people WHERE id=?";
